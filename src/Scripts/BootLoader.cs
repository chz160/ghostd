...
public partial class BootLoader : Control
{
	...
	public override void _Ready()
	{
		...
		//SignalName.TerminalTextFinished.Connect(OnTerminalTextFinished);
		var terminalText = GetNode<TerminalText>("TerminalText");
		terminalText.TerminalTextFinished += () =>
		{ 
			//TODO: Show Main Title and then switch to Main Terminal.
			
			//var global = GetNode<Global>("/root/Global");
			//global.GotoScene("res://Scenes/MainTerminal.tscn");
		};
	}
